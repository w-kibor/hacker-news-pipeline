...
Transitioned from SQL to Python-based Automation: Learned how to bridge the gap between a raw API and a database.

Cloud Security: Implemented IAM Service Account roles to securely interact with Google Cloud without hardcoding credentials.

Storage Efficiency: Understand the trade-offs between different file formats (JSON vs. Parquet) for analytical workloads.

🚀 How to Run
Clone the repo: git clone https://github.com/your-username/hacker-news-etl-pipeline.git

Install dependencies: pip install -r requirements.txt

Setup Credentials: Place your Google Cloud Service Account JSON in the credentials/ folder.

Run Extraction: python scripts/extract_hn.py

Run Load: python scripts/load_to_bq.py
